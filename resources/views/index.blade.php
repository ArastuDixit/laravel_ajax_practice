		...
		<div class="modal-content">
			<form action="#" method="POST" id="add_employee_form">
				...
				<div class="modal-footer">
					...
					<input type="submit" class="btn btn-success" id="add_employee_btn" value="Add">
				</div>
			</form>
		</div>
	</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="#" method="POST" id="edit_employee_form">
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
					<input type="submit" id="edit_employee_btn" class="btn btn-info" value="Save">
				</div>
			</form>
		</div>
	</div>
      ...
      $(document).on('click', '.edit', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#id").val(response.id);
            $("#editEmployeeModal").modal('show'); // Show the modal after populating data
